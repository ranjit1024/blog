        ...
        <div className="w-[100%] flex flex-col items-center">
            ...
            <div className="w-[80%] flex gap-10  flex-col ">
                ...
                <div className="flex justify-end items-end ">
                    <button type="button" className="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-md text-sm px-5 py-2.5 text-center -mt-4 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Pubish</button>
