export function ShowPasswordComp({ hide, setHide }: { hide: Boolean, setHide: React.Dispatch<React.SetStateAction<boolean>> }) {
...
export function HidePasswordComp({ show, setShow }: { show: Boolean, setShow: React.Dispatch<React.SetStateAction<boolean>> }) {
